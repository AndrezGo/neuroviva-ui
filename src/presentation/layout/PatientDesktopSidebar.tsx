...
import { patientTabItems } from '@/presentation/patient/navigation';
import type { PatientTab } from '@/presentation/patient/PatientTabBar';

interface PatientDesktopSidebarProps {
  activeTab: PatientTab;
}

/**
 * Fixed 240px sidebar for the Patient desktop layout.
 * Uses the brand gradient background (--gradient-brand) defined in globals.css.
 * Purely presentational — no hooks, no API calls.
 */
export function PatientDesktopSidebar({ activeTab }: PatientDesktopSidebarProps) {
  return (
    <aside
