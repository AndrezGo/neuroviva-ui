...
export type AdminTab = 'content' | 'community';
...
/**
 * Fixed bottom navigation bar for the Admin panel.
 * Mirrors DoctorTabBar — mobile only (lg:hidden).
 * No committee filtering — all tabs always visible.
 */
export function AdminTabBar({ activeTab }: AdminTabBarProps) {
  return (
    <nav
