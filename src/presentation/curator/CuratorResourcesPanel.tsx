...
import type { ResourceRequestType } from '@/domain/content/content.types';
...
/**
 * Shared feature container holding the "Crear recurso" form and the
 * "Pendientes de revisión" list. Used by both DoctorCuratoriaScreen and
 * AdminContentScreen — renders no TabBar and no role-specific page header.
 *
 * Calls useCuratorResources() and useDiseases() internally.
 */
export function CuratorResourcesPanel({ className }: CuratorResourcesPanelProps) {
  ...
  const handleCreate = useCallback(
    ...
    [title, type, url, description, diseaseId, create, resetForm],
  );
