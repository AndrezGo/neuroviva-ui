...
export function PatientArticlesScreen() {
  ...
  return (
    <div className="flex flex-col gap-5 px-4 py-6">
      ...
      {isError && (
        ...
        >
          <p className="text-sm font-medium text-red-700">
            {error ?? 'Ocurrió un error al cargar los artículos.'}
          </p>
      ...
      {/* Search input — only when there are articles to search through */}
      ...
      {!isLoading && !isError && !isEmpty && !noSearchResults && (
        <>
          <ul className="flex flex-col gap-3" aria-label="Lista de artículos científicos">
